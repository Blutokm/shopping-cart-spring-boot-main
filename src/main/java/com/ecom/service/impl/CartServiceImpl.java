...
public class CartServiceImpl implements CartService {
	...
	public Cart saveCart(Integer productId, Integer userId, Integer variantId) {
		...
		com.ecom.model.ProductVariant variant = variantRepository.findById(variantId).get();

		Cart cartStatus = cartRepository.findByProductIdAndUserIdAndColorAndSize(productId, userId, variant.getColor(), variant.getSize());
